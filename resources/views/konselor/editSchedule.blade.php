...
<!-- NavBar End -->
  ...
  <section class="md:max-w-[1200px] mx-auto w-[90%] mt-[120px] mb-[100px] flex flex-col justify-center items-center">
        ...
        <p class="font-bold mb-[20px]">Edit Jadwal Konseling</p>
        <form action="/konselor/editJadwalKonseling/{{ $jk->id }}" method="POST" class="md:w-[80%] w-[90%] mx-auto ">
          @csrf
            ...
            <div class="mb-5">
              ...
              <input type="number" id="harga_konseling" name="harga_konseling" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5  " value="{{ $jk->harga_konseling }}" placeholder="Masukkan Jam Konseling" required />
          </div>
