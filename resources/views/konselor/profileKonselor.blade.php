    ...
    <section class="mt-[40px] w-[100%] flex flex-col gap-5 p-[12px] rounded-[20px] bg-white" style="box-shadow: 4px 4px 24px 0px rgba(24, 124, 255, 0.12)">
      <div class="flex lg:flex-row flex-col gap-3">
        <div class="w-full flex lg:flex-row flex-col gap-[40px] justify-center items-center md:items-start md:justify-start">
          <div class="md:h-[244px] md:w-[244px] w-[320px] h-[300px] rounded-[20px]" style="background: url('{{ asset("picture/fotoKonselor/{$user->scanFotoKonselor}") }}'); background-size: cover; background-repeat: no-repeat; background-position: center"></div>
          <div class="flex flex-col md:flex-row">
            <div class="flex flex-col gap-[20px]">
              <p class="md:text-[24px] font-[500] text-[24px]">{{ $user->namaKonselor }} | Konselor</p>
              ...
              <div class="flex flex-row gap-3 hover:bg-slate-200 rounded-md p-3 border border-slate-500">
                ...
                <a href="https://maps.google.com/?q={{ $user->latitudeKonselor }},{{ $user->longitudeKonselor }}" target="_blank">Check Location on Google Maps</a>
              </div>
