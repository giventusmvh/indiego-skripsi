        ...
        <form action="/konselor/updatepasswordKonselor/{{ $konselor->id }}" method="POST" enctype="multipart/form-data"  class="md:w-[80%] w-[90%] mx-auto ">
          @csrf
                  @if ($errors->any())
                    ...
                    @endif
            <div class="mb-5">
                <label for="passwordKonselor" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Password Lama</label>
                <input type="password" id="passwordKonselor" name="passwordLama" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 " placeholder="Masukan Password Lama" required />
            </div>
            <div class="mb-5">
                <label for="passwordKonselor" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Password Baru</label>
                <input type="password" id="passwordKonselor" name="passwordBaru" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 " placeholder="Masukan Password Baru" required />
            </div>
            {{-- <div class="mb-5">
