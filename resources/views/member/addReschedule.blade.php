...
<nav id="navbar" class=" border-gray-200 fixed w-full z-50 top-0 left-0 h-max bg-[#242424]">
  ...
  <section class="md:max-w-[1200px] mx-auto w-[90%] mt-[120px] mb-[100px] flex flex-col justify-center items-center">
        ...
        <p class="font-bold mb-[20px]">Ajukan Reschedule</p>
        <form action="/home/actionAddReschedule/{{ $bk->id }}" method="POST" class="md:w-[80%] w-[90%] mx-auto ">
          @csrf
            ...
            <div class="mb-5">
              ...
              <input type="time" id="jam_konseling" name="jam_konseling" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5  " value="{{ $jk->jam_konseling }}" placeholder="Masukkan Jam Konseling" required  disabled/>
          </div>
            <div class="mb-5">
              <label for="topik_konseling" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Topik Konseling</label>
              <select id="topik_konseling" name="topik_konseling" disabled class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5">
            ...
            <div class="mb-5">
              ...
              <select disabled id="tipe_konseling" name="tipe_konseling" class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5">
            ...
            <div class="mb-5">
                <label for="tgl_ganti" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Ajukan tanggal baru</label>
                <input type="date" id="tgl_ganti" name="tgl_ganti" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5  "  placeholder="Masukkan Tanggal Konseling" required />
            </div>
            <div class="mb-5">
              <label for="jam_ganti" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Ajukan jam baru</label>
              <input type="time" id="jam_ganti" name="jam_ganti" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5  "  placeholder="Masukkan Jam Konseling" required  />
          </div>
